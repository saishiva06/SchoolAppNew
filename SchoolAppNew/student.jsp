                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                             		 <tr> <% if (mydata != null && mydata.size() > 0) { for (int i = 0; i < mydata.size(); i++) { 	Student student = mydata.get(i); %>
									 ...
									 <td><input type="button" name="edit" value="Edit" class="btn btn-primary btn-sm" 	onclick="editStudent('<%=student.getRollno()%>')"/></td>
				    				 <td><input type="button" name="delete" value="Delete" class="btn btn-danger btn-sm" onclick="deleteStudent('<%=student.getRollno()%>')" /></td>
  								     <td><input type="button" name="view" value="View" class="btn btn-primary btn-sm" onclick="viewStudent('<%=student.getRollno()%>')" /></td>
  								     </tr><% }}	%>
							       </tbody>
	                            </table>
                            </div>
