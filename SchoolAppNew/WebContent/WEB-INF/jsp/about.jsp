				...
				<div class="page-content">
					<div class="row page-row">
						<article class="welcome col-md-8 col-sm-7">
							...
							<p>
								narayanaolympiadschools was establsihed in 2003 as Saradha High
								School in Mustafa nagar Khammam.after successfull 12 years in
								education system now name changed to Sri narayana Olampiad
								Schools. <br>
							<h4>Our Programms:</h4>
							<br>We have designed the following programs to train the
							students in our school. <br>Two huge campuses with good
							ventilation as well as environment. <br>Nursery to 5th class
							CBSE syllabus. <br>6 to 10th class STATE/CBSE/ICSE/NCERT/IIT
							Integrated syllabus. <br>For kids(Nursery/LKG/UKG) teaching
							through play way methods . <br>Audio & visual for better
							understanding for critical concepts. <br>Bus facility to all
							routes for day scholar students.
							</p>
							<br>
							...
							<blockquote class="custom-quote">
								...
								<p class="people">
									...
									<span class="title">Principle, Narayana Olympiad Schools</span>
								</p>
							</blockquote>
						</article>
						<!--//page-content-->
						...
						<aside
							...
							<section class="widget has-divider">
								...
								<p>Donec pulvinar arcu lacus, vel aliquam libero scelerisque
									a. Cras mi tellus, vulputate eu eleifend at, consectetur
									fringilla lacus. Nulla ut purus.</p>
								<a class="btn btn-theme" href="#"><i class="fa fa-download"></i>Download
									now</a>
							</section>
							<!--//widget-->
									...
									<div class="carousel-inner">
										<div class="item">
											<blockquote class="quote">
												...
												eget ipsum. Nunc pulvinar ut nulla eget sollicitudin. In hac
