...
<body>
						...
						<div class="team-wrapper col-md-8 col-sm-7">
							<div class="row page-row">
								<figure class="thumb col-md-3 col-sm-4 col-xs-4">
									<img class="img-responsive" src="assets/images/team/team-3.jpg"
										alt="" />
								</figure>
								<div class="details col-md-9 col-sm-8 col-xs-4">
									<h3 class="title">CH.V N CHARY (MA (HINDHI),MA
										(ENGLISH),MA
										(HISTORY),Jyotheshyasiromani,vastuvisharadha,B.Ed.)</h3>
									<h4>Chairman</h4>
									<p>Hewas retired Headmaster and he has got 44 years
										experience in his teaching field of government as well as
										private. He was awarded for his excellence teaching which are
										DISTRICT, STATE, NATIONAL best teacher awards. For his social
										service, He was awarded with X-Ray excellency award, Mother
										Theresa award, best scout master Governor award,National
										integration award.</p>
								</div>
							</div>
							<div class="row page-row">
								<figure class="thumb col-md-3 col-sm-4 col-xs-4">
									<img class="img-responsive" src="assets/images/team/team-4.jpg"
										alt="" />
								</figure>
								<div class="details col-md-9 col-sm-8 col-xs-4">
									<h3 class="title">A.SANDEEP KUMAR (M.SC (CHEMISTRY), NET)</h3>
									<h4>Secretary and Correspondent</h4>
									<p>He has 12 years experience as a TEACHER AND LECTURER in
										CHEMISTRY.He has given his best services to four university
										students in CHEMISTRY.He worked as a A.E, E.E for inter,
										degree and postgraduate (M.Sc.Chemistry).</p>
								</div>
							</div>
							<div class="row page-row">
								<figure class="thumb col-md-3 col-sm-4 col-xs-4">
									<img class="img-responsive" src="assets/images/team/team-2.jpg"
										alt="" />
								</figure>
								<div class="details col-md-9 col-sm-8 col-xs-4">
									<h3 class="title">CH.R B CHAKRADHAR M.Sc(
										Maths),MA(English),MA(Hindhi),B.Ed.</h3>
									<h4>Director & Principal</h4>
									<p>He has worked as a TEACHER and LECTURER in MATHS for 11
										years. He is consider as IIT Maths teacher by teaching maths.</p>
								</div>
							</div>
							<div class="row page-row">
								<figure class="thumb col-md-3 col-sm-4 col-xs-4">
									<img class="img-responsive" src="assets/images/team/team-1.jpg"
										alt="" />
								</figure>
								<div class="details col-md-9 col-sm-8 col-xs-4">
	...
	<script type="text/javascript"
		SRC="assets/plugins/jflickrfeed/jflickrfeed.min.js"></script>
</body>
</html>
