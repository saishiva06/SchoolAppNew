        ...
        <div class="content container">
            <div class="page-wrapper">
                <header class="page-heading clearfix">
                    <h1 class="heading-title pull-left">School Gallery <small> </small></h1>
                    <div class="breadcrumbs pull-right">
                        <ul class="breadcrumbs-list">
                            <li class="breadcrumbs-label">You are here:</li>
                            <li><a href="index.do">Home</a><i class="fa fa-angle-right"></i></li>
                            <li class="current">School Gallery</li>
                        </ul>
                    </div><!--//breadcrumbs-->
                </header> 
                    ...
                    <div class="row page-row">
                        <div class="col-md-4 col-sm-4 col-xs-12 text-center">
                            <div class="album-cover">
                                <a href="gallery-album.do"><img class="img-responsive" src="assets/images/gallery/gallery-thumb-1.jpg" alt="" /></a>
                                <div class="desc">
                                    <h4><small><a href="#">Album Title</a></small></h4>
                                    <p>Integer ornare nisl tortor, sed condimentum metus pulvinar ut.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12 text-center">
                            <div class="album-cover">
                                <a href="gallery-album.do"><img class="img-responsive" src="assets/images/gallery/gallery-thumb-2.jpg" alt="" /></a>
                                <div class="desc">
                                    <h4><small><a href="#">Album Title</a></small></h4>
                                    <p>Aenean dictum urna nec ligula consectetur, id ornare leo tincidunt. </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12 text-center">
                            <div class="album-cover">
                                <a href="gallery-album.do"><img class="img-responsive" src="assets/images/gallery/gallery-thumb-3.jpg" alt="" /></a>
                                <div class="desc">
                                    <h4><small><a href="#">Album Title</a></small></h4>
                                    <p>Suspendisse at purus ac neque auctor viverra vel in arcu. Quisque commodo augue nisi.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12 text-center">
                            <div class="album-cover">
                                <a href="gallery-album.do"><img class="img-responsive" src="assets/images/gallery/gallery-thumb-4.jpg" alt="" /></a>
                                <div class="desc">
                                    <h4><small><a href="#">Album Title</a></small></h4>
                                    <p>Suspendisse at purus ac neque auctor viverra vel in arcu. </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12 text-center">
                            <div class="album-cover">
                                <a href="gallery-album.do"><img class="img-responsive" src="assets/images/gallery/gallery-thumb-5.jpg" alt="" /></a>
                                <div class="desc">
                                    <h4><small><a href="#">Album Title</a></small></h4>
                                    <p>Suspendisse at purus ac neque auctor viverra vel in arcu.</p>
                                </div>
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12 text-center">
                            <div class="album-cover">
                                <a href="gallery-album.do"><img class="img-responsive" src="assets/images/gallery/gallery-thumb-6.jpg" alt="" /></a>
                                <div class="desc">
                                    <h4><small><a href="#">Album Title</a></small></h4>
